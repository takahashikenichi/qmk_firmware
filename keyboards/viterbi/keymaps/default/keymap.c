 ...
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * | RASE | Shift|   Z  |   X  |   C  |   V  |   B  |      |   N  |   M  |   ,  |   .  |   /  |  _   |   ]  |
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * | LOWR | Ctrl | GUI  | Alt  |      | Eisu |Space |      |Space | Kana | Left |  Up  | Down | Right|   \  |
 * `------------------------------------------------'      `------------------------------------------------'
 */
  [_QWERTY] = KC_KEYMAP(
  //,----+----+----+----+----+----+----.    ,----+----+----+----+----+----+----.
  ...
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     RASE,LSFT, Z  , X  , C  , V  , B  ,      N  , M  ,COMM,DOT ,SLSH,INT1,BSLS,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     LOWR,LCTL,LGUI,LALT,    ,LANG2,SPC ,    SPC ,LANG1,LEFT,UP ,DOWN,RGHT,JYEN
  //`----+----+----+----+----+----+----'    `----+----+----+----+----+----+----'
  ),
